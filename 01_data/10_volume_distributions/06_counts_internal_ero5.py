...
for group in ['ASPSF', 'ProDem']:
	...
	for subject_folder in subject_folders:
		...
		for binarizer_name, image_name, mask_name in [
			# orig
			('0.0500__orig',	'T1__bias_corrected.nii.gz',												'T1__brain_mask_ero5.nii.gz'),
			('0.1375__orig',	'T1__bias_corrected__normalized__bin01375.nii.gz',	'T1__brain_mask_ero5.nii.gz'),
			('0.2750__orig',	'T1__bias_corrected__normalized__bin0275.nii.gz',		'T1__brain_mask_ero5.nii.gz'),
			('0.4125__orig',	'T1__bias_corrected__normalized__bin04125.nii.gz',	'T1__brain_mask_ero5.nii.gz'),

			# nlin
			('0.0500__nlin',	'T1__bias_corrected_@_MNI152_1mm_nlin.nii.gz',												'T1__brain_mask_@_MNI152_1mm_nlin_ero5.nii.gz'),
			('0.1375__nlin',	'T1__bias_corrected_@_MNI152_1mm_nlin__normalized__bin01375.nii.gz',	'T1__brain_mask_@_MNI152_1mm_nlin_ero5.nii.gz'),
			('0.2750__nlin',	'T1__bias_corrected_@_MNI152_1mm_nlin__normalized__bin0275.nii.gz',		'T1__brain_mask_@_MNI152_1mm_nlin_ero5.nii.gz'),
			('0.4125__nlin',	'T1__bias_corrected_@_MNI152_1mm_nlin__normalized__bin04125.nii.gz',	'T1__brain_mask_@_MNI152_1mm_nlin_ero5.nii.gz'),
    ]:
			# image
...
with open('counts_internal_ero5.json', 'w') as outfile:
