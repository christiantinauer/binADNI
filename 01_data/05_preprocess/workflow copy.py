...
def build_datasink_node(target_base_dir, workflow_name):
	return Node(DataSink(
		...
		regexp_substitutions=[
			# T1
			(r'T1/T1_raw_reoriented_roi.nii.gz', 'T1.nii.gz'),
			(r'T1_bias_corrected/T1_raw_reoriented_roi_maths.nii.gz', 'T1__bias_corrected.nii.gz'),
			(r'T1_bias_image/T1_raw_reoriented_roi_ssroi_bias.nii.gz', 'T1__bias_estimation.nii.gz'),

			# T1 @ MNI
			(r'regT1_to_MNI_dof6/T1_raw_reoriented_roi_maths_flirt.nii.gz', 'T1__bias_corrected_@_MNI152_1mm_dof6.nii.gz'),
			(r'regT1_to_MNI_nlin/T1_raw_reoriented_roi_maths_warp.nii.gz', 'T1__bias_corrected_@_MNI152_1mm_nlin.nii.gz'),

			# T1 registration files
			(r'regMatrix_dof6/T1_raw_reoriented_roi_maths_ssroi_brain_masked_flirt.mat', 'T1_to_MNI152_1mm_dof6.mat'),
			(r'regMatrix_dof12/T1_raw_reoriented_roi_maths_ssroi_brain_masked_flirt.mat', 'T1_to_MNI152_1mm_dof12.mat'),
			(r'regFieldFile_nlin/T1_raw_reoriented_roi_maths_field.nii.gz', 'T1_1mm_to_MNI152_warp.nii.gz'),
			(r'regFieldCoeffFile_nlin/T1_raw_reoriented_roi_maths_fieldwarp.nii.gz', 'T1_to_MNI152_warpcoeff.nii.gz'),

			# # brain masks
			(r'stdmasked_brain_mask/T1_raw_reoriented_roi_maths_ssroi_brain_mask_masked.nii.gz', 'T1__brain_mask.nii.gz'),
			(r'regBrainMask_to_MNI_dof6/T1_raw_reoriented_roi_maths_ssroi_brain_masked_flirt_bin.nii.gz', 'T1__brain_mask_@_MNI152_1mm_dof6.nii.gz'),
			(r'regBrainMask_to_MNI_nlin/T1_raw_reoriented_roi_maths_ssroi_brain_masked_warp_bin.nii.gz', 'T1__brain_mask_@_MNI152_1mm_nlin.nii.gz'),

			# # eroded brain masks
			(r'regT1_erode/T1_raw_reoriented_roi_maths_ssroi_brain_mask_masked_ero.nii.gz', 'T1__brain_mask_ero5.nii.gz'),
			(r'regT1_brainmask_erode_dof6/T1_raw_reoriented_roi_maths_ssroi_brain_masked_flirt_bin_ero.nii.gz', 'T1__brain_mask_@_MNI152_1mm_dof6_ero5.nii.gz'),
			(r'regT1_brainmask_erode_nlin/T1_raw_reoriented_roi_maths_ssroi_brain_masked_warp_bin_ero.nii.gz', 'T1__brain_mask_@_MNI152_1mm_nlin_ero5.nii.gz'),
...
def preprocess(studies, select_templates, target_base_dir, processor_count=1):
	...
	preprocess_workflow.write_graph(dotfilename='./graphs/preprocess.dot', graph2use='colored', simple_form=True)
