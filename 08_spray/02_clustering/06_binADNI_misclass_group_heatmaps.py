...
data_base_path = os.path.join(this_file_path, 'binADNI_misclass_group_means/scale_0.4')
target_base_path = os.path.join(this_file_path, 'binADNI_misclass_group_heatmaps')
...
for (model_title, model_name, binarizer) in [
  ('A2, FN', 'A2_heatmaps_misclass_1',   None),
  ('A2, FP', 'A2_heatmaps_misclass_0',   None),
  ('C2, FN', 'C2_heatmaps_misclass_1',   0.275),
  ('C2, FP', 'C2_heatmaps_misclass_0',   0.275),
]:
